...
function EntertainmentComp() {
 ...
 const {data, loading, error} = useFetch("https://newsapi.org/v2/top-headlines?country=us&category=entertainment&apiKey=ffb8136ba46542b3b04497ea8fc4a206")
  console.log(data)
